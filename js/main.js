...
function initPlayCtrl(){
    ...
    playCtrl.find(".collect").bind("click",function(){
        if ($(this).style.background == "url(images/pcrl/collected.png)") {
            console.log("红心")
            $(this).style.background = "url(images/pcrl/collect.png)";
        } else {
            console.log("去除红心")
            $(this).style.background = "url(images/pcrl/collected.png)";
        }
    });
